...
export const calculateNewCoords = (coordinateX, coordinateY, angle, moveStep = 1) => {
...
export const projectileIsOutOfField = (distance, projectilePivotX, projectilePivotY, projectileWidth, projectileHeight, angle, fieldWidth, fieldHeight) => {
...
export const doesLineInterceptCircle = (A, B, C, radius) => {
  var dist;
  const v1x = B.x - A.x;
  const v1y = B.y - A.y;
  const v2x = C.x - A.x;
